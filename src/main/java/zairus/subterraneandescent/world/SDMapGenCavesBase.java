...
/**
 * 
 * Temporarily basing on vanilla nether caves gen, to be modified
 *
 */
public class SDMapGenCavesBase extends MapGenBase
{
	...
	protected void addRoom(long seed, int p_180705_3_, int p_180705_4_, ChunkPrimer p_180705_5_, double p_180705_6_, double p_180705_8_, double p_180705_10_)
	{
		this.addTunnel(seed, p_180705_3_, p_180705_4_, p_180705_5_, p_180705_6_, p_180705_8_, p_180705_10_, 1.0F + this.rand.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D);
	}
	
	protected void addTunnel(long seed, int p_180704_3_, int p_180704_4_, ChunkPrimer p_180704_5_, double p_180704_6_, double p_180704_8_, double p_180704_10_, float p_180704_12_, float p_180704_13_, float p_180704_14_, int p_180704_15_, int p_180704_16_, double p_180704_17_)
	{
		...
		for (boolean flag = random.nextInt(4) == 0; p_180704_15_ < p_180704_16_; ++p_180704_15_)
		{
	...
	protected void recursiveGenerate(World worldIn, int chunkX, int chunkZ, int p_180701_4_, int p_180701_5_, ChunkPrimer chunkPrimer)
	{
		int i = this.rand.nextInt(this.rand.nextInt(this.rand.nextInt(12) + 1) + 1);
		...
		for (int j = 0; j < i; ++j)
		{
			...
			if (this.rand.nextInt(4) == 0)
			{
				this.addRoom(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimer, d0 * factor, d1 * factor, d2 * factor);
			...
			for (int l = 0; l < k; ++l)
			{
				...
				this.addTunnel(this.rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimer, d0 * factor, d1 * factor, d2 * factor, f2 * 2.0F, f, f1, 0, 0, 0.5D);
			}
		}
	}
}
